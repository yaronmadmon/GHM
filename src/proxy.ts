...
export default auth((req) => {
  ...
  const isPublicApiRoute = nextUrl.pathname.startsWith("/api/apply") || nextUrl.pathname.startsWith("/api/auth") || nextUrl.pathname.startsWith("/api/uploadthing") || nextUrl.pathname.startsWith("/api/lease-sign") || nextUrl.pathname.startsWith("/api/portal/setup") || nextUrl.pathname.startsWith("/api/mora");
